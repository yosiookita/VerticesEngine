...
namespace VerticeEnginePort.Base
{
    ...
    {        
        ...
        public override void LoadContent()
        {
            ...
            //plane = new xPlane(Engine, ((GameEngine)Engine).Model_Sandbox_WorkingPlane, Vector3.Zero);
            base.LoadContent();
            Camera.CameraType = CameraType.Orbit;
//
//            ship = new Ship(Engine, ((GameEngine)Engine).Model_Ship, new Vector3(0, 30, 0), ShipController.Player);
...
//            plane.World = Matrix.CreateTranslation(new Vector3(0, -10, 0));
        ...
        public override void HandleInput(InputHelper input)
        {
            ...
            {
                Engine.AddScreen(new PauseMenuScreen(), ControllingPlayer);
            }
            else
            {
