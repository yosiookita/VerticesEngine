...
namespace Virtex.App.VerticesTechDemo
{
    public class ModelObjs : vxSandboxEntity
    {
        ...
        public static vxSandboxEntityRegistrationInfo EntityDescription
        {
            get
            {
                ...
                "Models/items/wooden crate/wooden crate",
                    ...
                    {
                        return new ModelObjs(Engine, Vector3.Zero);
                    });
            }
        }
        ...
        public ModelObjs(vxEngine GameEngine, Vector3 StartPosition) :
            base(GameEngine, VerticesTechDemoGame.Model_Items_ModelObjs, StartPosition)
        {
            ...
            Engine.Current3DSceneBase.BEPUPhyicsSpace.Add(entity);
            Engine.Current3DSceneBase.BEPUDebugDrawer.Add(entity);
            Engine.Current3DSceneBase.BEPUPhyicsSpace.Add(entityMover);
        ...
        public override void ToggleSimulation(bool IsRunning)
        {
            ...
            if (SandboxState == vxEnumSandboxGameState.Running)
            {
                ...
                Engine.Current3DSceneBase.BEPUPhyicsSpace.Remove(entityMover);
        ...
        {
            base.RenderMesh(RenderTechnique, Camera);
            ...
            if (SandboxState == vxEnumSandboxGameState.EditMode)
            {
                ...
                if (SelectionState == vxEnumSelectionState.Hover)
                    SelectionState = vxEnumSelectionState.None;
            }
        }
    }
}
