...
public static partial class vxExtensions
{
	...
	/// <returns></returns>
    public static Rectangle GetBlurRectangle(this Rectangle rectangle, vxRenderer Renderer)
	{

        int factor = Renderer.GraphicsDevice.Viewport.Width / rectangle.Width;
