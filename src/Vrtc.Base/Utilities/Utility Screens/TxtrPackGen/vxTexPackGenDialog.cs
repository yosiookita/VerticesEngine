...
namespace VerticesEngine.UI.Dialogs.Utilities
{
    ...
    public class vxTexPackGenDialog : vxDialogBase
	{
		...
		public override void Draw(GameTime gameTime)
		{
			...
			Engine.SpriteBatch.Begin("Tex Pack Gen");
			...
			if (hasFired)
			{
				...
				if (currentTexture != null)
				{
                    ...
                    DrawLine("");
					Engine.SpriteBatch.Draw(currentTexture,
						...
						if (scaleIndex == 0)
						{
							...
							switch (textureToShrink)
							{
								case TextureToShrink.DiffuseMap:
									currentTexture = mesh.Material.UtilityEffect.DiffuseTexture;
									break;
								case TextureToShrink.NormalMap:
									currentTexture = mesh.Material.UtilityEffect.NormalMap;
									break;
								case TextureToShrink.SpecularMap:
									currentTexture = mesh.Material.UtilityEffect.SurfaceMap;
									break;
