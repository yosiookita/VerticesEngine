...
namespace VerticesEngine
{
    ...
    public class InstanceSet
    {
        ...
        public InstanceSet(vxEngine Engine)
        {
            ...
            mGraphicsDevice = Engine.GraphicsDevice;
        ...
        public void Update()
        {
            ...
            if (instances.Count > 0)
            {
                    ...
                    (mInstanceDataStream.VertexCount < instances.Count))
                {
                    ...
                    mInstanceDataStream = new DynamicVertexBuffer(Engine.GraphicsDevice,
                    ...
                    */
                    ...
                    foreach (ModelMeshPart part in mesh.MeshParts)
                    {
                        ...
                        if (part.Effect.Parameters["CameraPos"] != null)
                            part.Effect.Parameters["CameraPos"].SetValue(Engine.Current3DSceneBase.Camera.WorldMatrix.Translation);
