...
//        {
//            get { return (vxGameplayScene3D)Engine.CurrentScene; }
//        }
...
//        public vxDefferredRenderPostProcess(vxRenderer3D Renderer) :
...
//            fog = vxInternalAssets.LoadInternalTexture2D("Textures/terrain/Heightmap");
//        }
...
//        {
//            Engine.GraphicsDevice.SetRenderTarget(RenderTargets.GodRaysMaskMap);
//            //Engine.GraphicsDevice.BlendState = BlendState.Opaque;
//            //Engine.GraphicsDevice.DepthStencilState = DepthStencilState.Default;
...
//                SunEntity.ScreenSpacePosition.X / Engine.GraphicsDevice.Viewport.Width,
//                SunEntity.ScreenSpacePosition.Y / Engine.GraphicsDevice.Viewport.Height);
...
//        {
//            //Render Light Pass
//            Engine.GraphicsDevice.SetRenderTarget(RenderTargets.LightMap);
...
//                Engine.GraphicsDevice.SetRenderTarget(_litScene);
...
//                Engine.GraphicsDevice.SetRenderTarget(_deferredLitScene);
...
//   Engine.GraphicsDevice.Viewport.Bounds.Contains(SunEntity.ScreenPosition.ToPoint()) &&
...
//                Parameters["CameraPos"].SetValue(Scene.Camera.WorldMatrix.Translation);
