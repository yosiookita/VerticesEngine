...
//        public vxSSRPostProcess(vxRenderer3D Renderer) :
...
//            {
//                Engine.GraphicsDevice.SetRenderTarget(SSRUVCoordMap);
...
//                Engine.SpriteBatch.Begin("PostProcess.SSR.GenerateUVMap()", 0, BlendState.Opaque, null, null, null, Effect);
//                Engine.SpriteBatch.Draw(Renderer.PeekAtCurrentTempTarget(), Scene.ViewportManager.MainViewport.Bounds,
//                    Color.White);
