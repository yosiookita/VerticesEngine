...
namespace VerticesEngine.Graphics
{
    ...
    public class vxAntiAliasPostProcess : vxRenderPass, vxIRenderPass
    {
        ...
        public vxAntiAliasPostProcess(vxRenderer Renderer) :
        base(Renderer, "FXAA", vxInternalAssets.PostProcessShaders.FXAA)
        {
        ...
        public void Apply()
        {
            ...
            {
                Engine.GraphicsDevice.SetRenderTarget(Renderer.GetNewTempTarget("Anti Aliasing Pass"));
                ...
                Engine.SpriteBatch.Begin("PostProcess.AntiAliasing.Apply()", 0, BlendState.Opaque, null, null, null, Effect);
                Engine.SpriteBatch.Draw(Renderer.GetCurrentTempTarget(), Vector2.Zero, Color.White);
