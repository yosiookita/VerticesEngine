...
//        public vxSSAOPostProcess(vxRenderer Renderer) :
...
//            {
//                Engine.GraphicsDevice.SetRenderTarget(SSAOStippleMap);
...
//                Engine.SpriteBatch.Begin("PostProcess.SSAO.Prepare()", 0, BlendState.Opaque, null, null, null, Effect);
//                Engine.SpriteBatch.Draw(DefaultTexture, Scene.ViewportManager.MainViewport.Bounds, Color.White);
