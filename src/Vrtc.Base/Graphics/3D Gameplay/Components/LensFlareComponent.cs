...
#region Initialization
        ...
        public void LoadContent()
        {
            ...
            glowSprite = vxInternalAssets.LoadInternalTexture2D("Graphics/Flares/glow");
            
            foreach (Flare flare in flares)
            {
                flare.Texture = vxInternalAssets.LoadInternalTexture2D(flare.TextureName);
            }
            ...
            //occlusionQuery = new OcclusionQuery(Engine.GraphicsDevice);
        }
...
#region Draw
        ...
        public void UpdateOcclusion()
        {
			...
			//vxConsole.WriteToInGameDebug(vxTexture2D.GetPixel(depth, 2, 2, Engine.GraphicsDevice.Viewport.Width).R);
			/*
            ...
            Engine.GraphicsDevice.BlendState = ColorWriteDisable;
            ...
            Engine.GraphicsDevice.DrawUserPrimitives(PrimitiveType.TriangleStrip, queryVertices, 0, 2);
