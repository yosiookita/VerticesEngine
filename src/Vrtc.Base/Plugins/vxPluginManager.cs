...
namespace VerticesEngine.Plugins
{
    ...
    public static class vxPluginManager
    {
        ...
        /// </summary>
        static vxIPlugin MainGameContentPack;
        ...
        internal static void LoadPlugins()
        {
            ...
            MainGameContentPack = Engine.Game.GetMainGameContentPack();
            MainGameContentPack.Initialise(Engine);

            // Load the DLC
            foreach (var dlc in Engine.Game.GetDLCPaths())
            ...
            {
                foreach (var devmod in Engine.LoadDevMods())
        ...
        static void LoadPluginContent(vxIPlugin plugin)
        {
        ...
        internal static void LoadContent()
        {
            ...
            LoadPluginContent(MainGameContentPack);
