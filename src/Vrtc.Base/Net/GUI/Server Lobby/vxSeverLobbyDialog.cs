...
namespace VerticesEngine.UI.Dialogs
{
    ...
    public class vxSeverLobbyDialog : vxDialogBase
    {
        ...
        /// </summary>
        public vxButtonControl Btn_LaunchServer;
    ...
    new Vector2(
            ...
            if (vxNetworkManager.Client.PlayerNetworkRole == vxEnumNetworkPlayerRole.Server)
            {
                ...
                Btn_LaunchServer = new vxButtonControl(Engine, "Launch Game", new Vector2(viewportSize.X / 2 - 115, viewportSize.Y / 2 + 20));
                Btn_LaunchServer.Clicked += Btn_LaunchServer_Clicked; ;
                InternalGUIManager.Add(Btn_LaunchServer);
                ...
                vxNetworkManager.Client.Connect(NetUtility.Resolve("localhost").ToString(),
                                                     vxNetworkManager.Server.Server.Configuration.Port, approval);
        ...
        public virtual vxServerLobbyPlayerItem GetNewPlayerLobbyItem(vxNetPlayerInfo playerInfo)
        {
            ...
            return new vxServerLobbyPlayerItem(Engine, 
                                               playerInfo,
                                               new Vector2(
        ...
        private void ClientManager_OtherPlayerConnected(object sender, vxNetClientEventPlayerConnected e)
        {
            ...
            //Set Item Width
			item.Width = ScrollPanel.Width - (int)(2 * this.ArtProvider.Padding.X) - ScrollPanel.ScrollBarWidth;
        ...
        public virtual void LaunchSession()
        {
            ...
            {
                //Turn off the Server
                vxNetworkManager.Server.Server.Configuration.AcceptIncomingConnections = false;
            }
        ...
        public override void Update(GameTime gameTime, bool otherScreenHasFocus, bool coveredByOtherScreen)
        {
            ...
            if (Btn_LaunchServer != null)
            {
                Btn_LaunchServer.Height = OKButton.Height;
