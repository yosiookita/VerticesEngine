...
namespace VerticesEngine
{
	...
	public partial class vxGameplayScene2D : vxGameplaySceneBase
	{
        ...
        protected override void LoadParticlePools()
        {
            ...
            {
                var particlePool = new vxParticlePool(particleSet.Key);
        ...
        public override void LoadContent ()
		{
            ...
            //float horScaling = Engine.GraphicsDevice.PresentationParameters.BackBufferWidth / baseScreenSize.X;
            //float verScaling = Engine.GraphicsDevice.PresentationParameters.BackBufferHeight / baseScreenSize.Y;

            //Vector3 screenScalingFactor = new Vector3(horScaling, verScaling, 1);
            //globalTransformation = Matrix.CreateScale(screenScalingFactor);

            //         Engine.InitMainRendertarget();

            //         PresentationParameters pp = GraphicsDevice.PresentationParameters;

            //         MainSceneResult = new RenderTarget2D(Engine.GraphicsDevice,
        ...
        */
			...
			bool coveredByOtherScreen)
		{
			...
			{
#endif
            float inc = (float)gameTime.ElapsedGameTime.TotalSeconds;
