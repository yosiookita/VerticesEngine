...
namespace VerticesEngine.Graphics
{
	...
	public static class vxAssetCreator2D
    {
		...
		internal static void Init()
		{
            ...
            _device = vxEngine.Instance.GraphicsDevice;
			_effect = new BasicEffect(_device);

            ContentManager contentManager = vxContentManager.Instance;

            _materials[MaterialType.Blank] = contentManager.Load<Texture2D>("Textures/Farseer/blank");
            _materials[MaterialType.Dots] = contentManager.Load<Texture2D>("Textures/Farseer/dots");
            _materials[MaterialType.Squares] = contentManager.Load<Texture2D>("Textures/Farseer/squares");
            _materials[MaterialType.Waves] = contentManager.Load<Texture2D>("Textures/Farseer/waves");
            _materials[MaterialType.Pavement] = contentManager.Load<Texture2D>("Textures/Farseer/pavement");
        }
