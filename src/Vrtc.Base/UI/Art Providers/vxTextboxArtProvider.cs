...
{
	public class vxTextboxArtProvider : vxArtProviderBase, IGuiArtProvider
	{
        ...
        public vxTextboxArtProvider(vxEngine Engine):base(Engine)
		{
			DefaultWidth = 150;
			DefaultHeight = 24;
		...
		public virtual void Draw(object guiItem)
		{
            ...
            if (DoShadow)
            {
                ...
                Engine.SpriteBatch.Draw(vxInternalAssets.Textures.Blank, BackRectangle, Color.Black * 0.5f);
            ...
            SpriteBatch.Draw(vxInternalAssets.Textures.Blank, Bounds.GetBorder(1), 
                (textbox.HasFocus ? Color.Black : Color.Black * 0.75f) * textbox.TransitionAlpha);

            // Draw the Inside
            SpriteBatch.Draw(vxInternalAssets.Textures.Blank, Bounds, 
            ...
            Engine.SpriteBatch.DrawString(Font, leftText, TextPosition.ToPoint().ToVector2(),
            (textbox.HasFocus ? Color.Black : Color.Black * 0.75f) * textbox.TransitionAlpha);

            //Engine.SpriteBatch.DrawString(Font, textbox.DisplayText, TextPosition.ToPoint().ToVector2(),
            //(textbox.HasFocus ? Color.Black : Color.Black * 0.75f) * textbox.TransitionAlpha);
            ...
            //			{
            //				Engine.SpriteBatch.DrawString(Font, line, pos,
            //	(textbox.HasFocus ? Color.Black : Color.Black * 0.75f) * textbox.TransitionAlpha);
            //			}
            //		}
            //             */
            ...
            //	(textbox.HasFocus ? Color.Black : Color.Black * 0.75f) * textbox.TransitionAlpha);
            //}
            //Engine.SpriteBatch.DrawString(Font, DisplayText, TextPosition, 
            //(textbox.HasFocus ? Color.Black : Color.Black * 0.75f) * textbox.TransitionAlpha);

            //Draw Caret Seperately
            Engine.SpriteBatch.DrawString(Font, Caret, textbox.CaretPosition, Color.Black * 0.75f * textbox.CaretAlpha);
        }
    }
}
