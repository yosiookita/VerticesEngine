	...
	public class vxDialogArtProvider : vxArtProviderBase, IGuiArtProvider
	{
       ...
       /// <summary>
		...
		public vxDialogArtProvider (vxEngine Engine):base(Engine)
		{
            ...
            TitleTextSize = vxGUITheme.Fonts.Font.MeasureString("A");
		...
		public virtual void Draw(object guiItem)
		{
			...
			Engine.SpriteBatch.Draw(BackgroundImage, FormBounds, Theme.Background.Color);

			// Draw the Title
            Engine.SpriteBatch.Draw(TitleBackgroundImage, TitleBounds.GetBorder(BorderWidth), Color.Black);
			Engine.SpriteBatch.Draw(TitleBackgroundImage, TitleBounds, TitleBackgroundColour);
            Engine.SpriteBatch.DrawString(TitleFont, dialog.Title, TitlePosition, TitleTextColour);
		}
	}
}
