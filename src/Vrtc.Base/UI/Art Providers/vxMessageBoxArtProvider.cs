...
{    /// <summary>
	...
	public class vxMessageBoxArtProvider : vxArtProviderBase, IGuiArtProvider
    {
        ...
        {
            return vxGUITheme.Fonts.FontTitle;
        }
        ...
        {
            Engine.SpriteBatch.Draw(BackgroundImage, FormBounds, Theme.Background.Color * Alpha * msgBox.TransitionAlpha);
        }


        public virtual void DrawText(vxMessageBox msgBox)
        {
            Engine.SpriteBatch.DrawString(Font, msgBox.Message, TextPosition.ToIntValue(),
        ...
        {
            // Draw the Title
            Engine.SpriteBatch.Draw(vxGUITheme.SpriteSheet, TitleBounds, TitleSpriteSheetRegion, TitleBackgroundColour * TitleAlpha * msgBox.TransitionAlpha);

            if (DoTitleTextShadow)
                Engine.SpriteBatch.DrawString(TitleFont, msgBox.Title, TitlePosition + TitleShadowPadding,
            ...
            Engine.SpriteBatch.DrawString(TitleFont, msgBox.Title, TitlePosition.ToIntValue(), TitleTextColour * TitleAlpha * msgBox.TransitionAlpha,
                                         0, Vector2.Zero,
                                         vxLayout.ScaleAvg,
                                         SpriteEffects.None, 1);
