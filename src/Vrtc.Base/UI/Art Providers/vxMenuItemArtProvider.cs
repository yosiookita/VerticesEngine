...
{    /// <summary>
	...
	public class vxMenuItemArtProvider : vxArtProviderBase, IGuiArtProvider
    {
		...
		public vxMenuItemArtProvider(vxEngine Engine):base(Engine)
        {
			...
			//BackgroundImage = Engine.InternalContentManager.Load<Texture2D>("Gui/DfltThm/vxGUITheme/vxMenuEntry/Bckgrnd_Nrml");
        }
        ...
        public virtual void Draw(object guiItem)
        {
            ...
            //if (DrawBackgroungImage)
                //Engine.SpriteBatch.Draw(BackgroundImage, menuEntry.Bounds, menuEntry.Colour * menuEntry.Opacity);

			if (DrawBackgroungImage)
                Engine.SpriteBatch.Draw(vxGUITheme.SpriteSheet, menuEntry.Bounds, SpriteSheetRegion, Theme.Background.Color * menuEntry.Opacity);
