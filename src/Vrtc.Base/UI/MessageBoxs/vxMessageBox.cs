...
namespace VerticesEngine.UI.MessageBoxs
{
    ...
    public class vxMessageBox : vxBaseScene
    {
        ...
        /// </summary>
        public vxGUIManager InternalGUIManager;
		...
		public virtual void SetButtonText()
		{
            if (OKButton != null)
            {
                OKButton.SetLocalisedText(vxLocalisationKey.OK);
                CancelButton.SetLocalisedText(vxLocalisationKey.Cancel);
            }
		}
        ...
        {
            this.ArtProvider = (vxMessageBoxArtProvider)vxGUITheme.ArtProviderForMessageBoxes.Clone();
		...
		public virtual void OnApplyButtonClicked (object sender, VerticesEngine.UI.Events.vxGuiItemClickEventArgs e)
		{
			if (Apply != null)
		...
		/// </summary>
		public virtual void OnOKButtonClicked (object sender, VerticesEngine.UI.Events.vxGuiItemClickEventArgs e)
		{
			if (Accepted != null)
		...
		/// </summary>
		public virtual void OnCancelButtonClicked (object sender, VerticesEngine.UI.Events.vxGuiItemClickEventArgs e)
		{
			OnCancel ();
		}
        ...
        public override void Draw(GameTime gameTime)
        {
			...
			SpriteBatch.Begin("UI - Message Box");
        ...
        public static void Show(string title, string text, vxEnumButtonTypes buttonTypes = vxEnumButtonTypes.Ok)
        {
            vxSceneManager.AddScene(new vxMessageBox(text, title, buttonTypes));
        }
