...
namespace VerticesEngine.UI.Controls
{
	...
	public class vxRibbonTabPage : vxTabPageControl
	{
        ...
        public override void DrawTab()
        {
            ...
            Engine.SpriteBatch.Draw(DefaultTexture, Tab.Bounds, Tab.GetStateColour(Theme.Background) * Opacity);
            ...
            Engine.SpriteBatch.DrawString(this.Font, Tab.Text, TxtPos.ToVector2(), Tab.GetStateColour(Theme.Text) * Opacity);
                                         //0,
                                         //Vector2.Zero,
                                         //vxLayout.ScaleAvg,
                                         //SpriteEffects.None,
