...
{
    public class vxRibbonToolbarSplitterControl : vxGUIControlBaseClass
    {
        /// <summary>
        ...
        public vxRibbonToolbarSplitterControl(vxRibbonControl Ribbon) : base(Ribbon.Engine, Vector2.Zero)
        {
