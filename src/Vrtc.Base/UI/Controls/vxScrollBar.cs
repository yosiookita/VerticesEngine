...
namespace VerticesEngine.UI.Controls
{
    ...
    /// </summary>
    public class vxScrollBar : vxGUIControlBaseClass
    {
        /// <summary>
        /// The parent panel.
        /// </summary>
        ...
        public vxScrollBar(vxEngine Engine, vxScrollPanel Parent, Vector2 Position, int TotalHeight, int ViewHeight) :
        base(Engine)
        {
            //Get Parent Panel
            ParentPanel = Parent;
            ...
            ResetLayout();
			ArtProvider = (vxScrollBarArtProvider)vxGUITheme.ArtProviderForScrollBars.Clone();
        }
