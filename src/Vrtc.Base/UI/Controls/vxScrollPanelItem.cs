...
namespace VerticesEngine.UI.Dialogs
{
	...
	/// </summary>
	public class vxScrollPanelItem : vxGUIControlBaseClass
	{
		/// <summary>
		/// The button image.
		/// </summary>
		...
		public vxScrollPanelItem(vxEngine Engine,
			string Text,
			Vector2 Position,
			Texture2D buttonImage,
								 int ElementIndex=0) : base(Engine)
		{
			...
			ArtProvider = (vxScrollPanelItemArtProvider)vxGUITheme.ArtProviderForScrollPanelItem.Clone ();
		}
...
#if !NO_DRIVER_OPENAL
			//SoundEffectInstance MenuHighlight = vxGUITheme.SoundEffects.SE_Menu_Hover.CreateInstance();
		...
		{
#if !NO_DRIVER_OPENAL
			//SoundEffectInstance equipInstance = vxGUITheme.SoundEffects.SE_Menu_Confirm.CreateInstance();
