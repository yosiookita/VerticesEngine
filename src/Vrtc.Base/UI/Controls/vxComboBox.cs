...
namespace VerticesEngine.UI.Controls
{
    ...
    /// </summary>
    public class vxComboBox : vxGUIControlBaseClass
    {
		...
		public vxComboBox(vxEngine Engine, string text, Vector2 position):base(Engine, position)
        {
            Text = text;

            this.Engine = Engine;
			this.Font = vxGUITheme.Fonts.FontSmall;
            ...
            DropDownArrow = vxInternalAssets.LoadInternalTexture2D("Textures/sandbox/misc/bullet_arrow_down");
        }
        ...
        {
            vxComboBoxItem item = new vxComboBoxItem(Engine, Item,
                Choices.Count, new Vector2((int)(Position.X),
                    Bounds.Bottom + (Choices.Count) * LineHeight));
        ...
        void OnComboBoxClicked (object sender, vxGuiItemClickEventArgs e)
		{
        ...
        void OnComboBoxPositionChanged (object sender, EventArgs e)
        {
        ...
        void OnItemClicked(object sender, vxGuiItemClickEventArgs e)
        {
    ...
    /// </summary>
    public class vxComboBoxItem : vxGUIControlBaseClass
    {
        public vxEnumTextHorizontalJustification TextJustification = vxEnumTextHorizontalJustification.Center;
        ...
        /// <param name="position">Position.</param>
        public vxComboBoxItem(vxEngine Engine, string text, int Index, Vector2 position) : base(Engine)
        {
            this.Engine = Engine;

            // This will be set anyways by the Owning Combox Control
            Font = vxGUITheme.Fonts.FontSmall;
        ...
        public override void Draw()
        {
            ...
            //Draw Button
            Engine.SpriteBatch.Draw(DefaultTexture, Bounds.GetBorder(-1), Theme.Background.Color);
            Engine.SpriteBatch.DrawString(Font, Text, Bounds.Center.ToVector2() + Vector2.UnitY, Theme.Text.Color, vxLayout.Scale, txtSize/2);
        }
    }
}
