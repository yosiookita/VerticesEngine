...
{
    public class vxListViewScrollBar : vxGUIControlBaseClass
    {
        ...
        public vxListViewScrollBar(vxEngine Engine, vxListView Parent, Vector2 Position, int TotalHeight, int ViewHeight):
		base(Engine)
        {
