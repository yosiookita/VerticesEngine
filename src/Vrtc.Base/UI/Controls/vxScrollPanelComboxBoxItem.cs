...
namespace VerticesEngine.UI.Controls
{
	...
	public class vxScrollPanelComboxBoxItem : vxScrollPanelItem
    {
		...
		public vxScrollPanelComboxBoxItem(vxEngine Engine, vxGUIManager UIManager, string Title, string Value) :
            this(Engine, UIManager, Title, Value, Vector2.Zero)
        { }
		...
		public vxScrollPanelComboxBoxItem(vxEngine Engine, vxGUIManager UIManager, string Title, string Value, Vector2 Position): 
            base(Engine, "", Vector2.Zero, null, 0)
        {
            ...
            ValueComboBox = new vxComboBox(Engine, Value, Position + new Vector2(275, 10));
