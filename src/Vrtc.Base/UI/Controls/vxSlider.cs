...
namespace VerticesEngine.UI.Controls
{
    ...
    /// </summary>
    public class vxSlider : vxGUIControlBaseClass
    {
		/// <summary>
		...
		public vxSlider(vxEngine Engine, float Min, float Max, float Value, Vector2 position) :
		this(Engine, Min, Max, Value, position, 150)
		{
		}
		...
		public vxSlider(vxEngine Engine, float Min, float Max, float Value, Vector2 position, int SliderLength)
            : base(Engine, position)
        {
            ...
            this.ArtProvider = (vxSliderArtProvider)vxGUITheme.ArtProviderForSlider.Clone ();
