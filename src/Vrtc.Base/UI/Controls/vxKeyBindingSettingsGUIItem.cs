...
namespace VerticesEngine.UI.Controls
{
    ...
    /// </summary>
	public class vxKeyBindingSettingsGUIItem : vxGUIControlBaseClass
    {
        ...
        public vxKeyBindingSettingsGUIItem(vxEngine Engine, vxGUIManager UIManager, string Title, vxKeyBinding KeyBinding, object id, Vector2 position)
			: base(Engine, position)
        {
			...
			Button = new vxButtonControl(Engine, KeyBinding.Key.ToString(), position + new Vector2(200, 10));
        ...
        public override void Draw()
        {
            ...
            //
            //Draw Button
            Engine.SpriteBatch.Draw(vxInternalAssets.Textures.Blank, Bounds, Color.Black * 0.5f);
        }
    }
}
