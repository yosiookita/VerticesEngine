...
namespace VerticesEngine.UI.Controls
{
    ...
    public class vxPropertyItemColour : vxPropertyItemBaseClass
    {
        ...
        base(propertyGroup, PropertyInfo, TargetObjects)
        {
            ...
            XsubItem = new vxPropertyItemBaseClass(propertyGroup, rProperty, slctnst);
            YsubItem = new vxPropertyItemBaseClass(propertyGroup, gProperty, slctnst);
            ZsubItem = new vxPropertyItemBaseClass(propertyGroup, bProperty, slctnst);
        ...
        public override object GetPropertyValue()
        {
            ...
            else if (result is PropertyResponse)
            {
                ...
                XsubItem.Value = VariesString;
                YsubItem.Value = VariesString;
                ZsubItem.Value = VariesString;
            }
