...
namespace VerticesEngine.UI.Controls
{
	...
	/// Property item group.
	/// </summary>
	public class vxPropertyGroup : vxGUIControlBaseClass
	{
		...
		base(PropertyControl.Engine)
		{
			...
			ToggleButton = new vxToggleImageButton(Engine,
											Vector2.Zero,
											 vxInternalAssets.LoadInternalTexture2D("Textures/sandbox/misc/bullet_toggle_plus"),
											vxInternalAssets.LoadInternalTexture2D("Textures/sandbox/misc/bullet_toggle_minus"));
        ...
        {
            return vxLayout.GetScaledSize(Math.Max(Font.LineSpacing * 16/13, 16));
        }
		...
		public override void DrawText()
		{
            ...
            SpriteBatch.DrawString(Font, Text, textPos.ToIntValue() + new Vector2(Borders.X, 0), Color.White, vxLayout.Scale);
