...
namespace VerticesEngine.UI.Controls
{
    ...
    public class vxPropertiesScrollPanelControl : vxScrollPanel
    {
        ...
        public vxPropertiesScrollPanelControl(vxEngine Engine, Vector2 Position, int Width, int Height)
            : base(Engine, Position, Width, Height)
        {
            ...
            LineBatch = new vxLineBatch(Engine.GraphicsDevice);
        }
        ...
        public override void AddItem(vxGUIControlBaseClass guiItem)
        {
