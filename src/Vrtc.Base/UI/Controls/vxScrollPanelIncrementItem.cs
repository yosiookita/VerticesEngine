...
namespace VerticesEngine.UI.Controls
{
    ...
    public class vxScrollPanelIncrementItem : vxScrollPanelItem
	{
		...
		public vxScrollPanelIncrementItem(vxScrollPanel ScrollPanel, string Title, float Value, float MinValue, float MaxValue, float Tick) :
					base(ScrollPanel.Engine, "", Vector2.Zero, null, 0)
		{
			...
			AddButton = new vxButtonImageControl(Engine, Vector2.Zero + pos.ToVector2(),
				RightArrow,
				RightArrowHover,
				Height-pos.X*2,
				Height-pos.Y*2)
			...
			SubtractButton = new vxButtonImageControl(Engine, Vector2.Zero + pos.ToVector2(),
				LeftArrow,
				LeftArrowHover,
				Height-pos.X*2,
				Height-pos.Y*2)
		...
		public override void Draw()
		{
			...
			Engine.SpriteBatch.DrawString(Font, Value.ToString(),
			                              new Vector2(
