...
{
    public enum vxGUIItemOrientation
    {
        Top,
        Left,
        Right,
    ...
    /// GUI Base Class.
    /// </summary>
    public class vxGUIControlBaseClass
    {
        ...
        {
            return typeof(vxGUIControlBaseClass);
        }
        ...
        /// The item theme.
        /// </summary>
        public vxGUIControlTheme Theme = new vxGUIControlTheme();
        ...
        public object LocalisationKey;

        public virtual void RefreshLocalisation()
        {
            Text = Engine.Language[LocalisationKey];
        }

        public void SetLocalisedText(object key, string postface="")
        {
            Text = Engine.Language[key] + postface;
        }
        ...
        public SpriteFont Font
        {
            ...
            {
                if (_font == null)
                    _font = Font = vxGUITheme.Fonts.Font;
                return _font;
            }
        ...
        /// </summary>
        public event EventHandler<vxGuiItemClickEventArgs> DoubleClicked;

        /// <summary>
        /// Event Raised when this item is added to a GUI Manager
        /// </summary>
        public event EventHandler<vxGuiManagerItemAddEventArgs> AddedToGUIManager;
        ...
        /// </summary>
        //public Color //Colour_Text = Color.Black;

        ///// <summary>
        ///// Normal Colour Of GUI Item
        ///// </summary>
        //public Color Colour = Color.DarkOrange;

        ///// <summary>
        ///// Normal Colour Of GUI Item
        ///// </summary>
        //public Color //Color_Normal = Color.DarkOrange;

        ///// <summary>
        ///// Highlighted Colour Of GUI Item
        ///// </summary>
        //public Color Color_Highlight = Color.Orange;

        ///// <summary>
        ///// Selected Colour Of GUI Item
        ///// </summary>
        //public Color Color_Selected = Color.DeepSkyBlue;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VerticesEngine.UI.vxGUIControlBaseClass"/> class.
        /// </summary>
		public vxGUIControlBaseClass(vxEngine Engine) { this.Engine = Engine; }
        ...
        public vxGUIControlBaseClass(vxEngine Engine, Vector2 position)
        {
            this.Engine = Engine;
            ...
            if (IsEnabled && HasMouseBeenUpYet)
            {
                ...
                if (doubleClickCounter < 20 && DoubleClicked != null)
                {
                    ...
                    if (DoubleClicked != null)
                        DoubleClicked(this, new vxGuiItemClickEventArgs(this));
                }
                else
                {
                    // Raise the Clicked event.
        ...
        public virtual void OnGUIManagerAdded(vxGUIManager UIManager)
        {
            this.UIManager = UIManager;

            // Raise the Added event.
            if (AddedToGUIManager != null)
                AddedToGUIManager(this, new vxGuiManagerItemAddEventArgs(UIManager));
        }
        ...
        public virtual void Update()
        {
			...
			if (IsUpdateable || vxInput.IsMouseButtonPressed(MouseButtons.LeftButton))
			{
				if (Bounds.Intersects(vxInput.CursorPixel) && vxInput.IsInit)
				{
					...
					//if (_hasMouseBeenUpYet && vxInput.IsNewMainInputUp() && vxInput.IsDragging == false)
					if (_hasMouseBeenUpYet && vxInput.IsNewMainInputUp())
						Select();
					else
						Hover();
#endif
...
#region ToolTip
        ...
        public virtual void DrawToolTip()
        {
            if (CanDrawToolTip)
            {
                vxGUITheme.ArtProviderForToolTips.Draw(this);
            }
            else
            {
                ToolTipAlpha = 0;
