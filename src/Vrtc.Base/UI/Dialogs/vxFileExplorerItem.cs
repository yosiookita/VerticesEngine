...
namespace VerticesEngine.UI.Dialogs
{
	...
	public class vxFileExplorerItem : vxScrollPanelItem
	{
		...
		public vxFileExplorerItem(vxEngine Engine,
                                  FileInfo FileInfo,
								int ElementIndex, bool IsDirectory = false) :
		base(Engine,
             FileInfo.Name,
			 Vector2.Zero,
			 null,
			 ElementIndex)
		{
            ...
            ArtProvider = (vxFileExplorerItemArtProvider)vxGUITheme.ArtProviderForFileExplorerItem.Clone();
            ...
            Texture2D folderIcon = vxInternalAssets.LoadInternalTexture2D("Textures/sandbox/rbn/main/open_16");
            ...
            {
                case ".zip":
                    icon = vxInternalAssets.LoadInternalTexture2D("Textures/gui/icons/zip");
                    break;

                case ".png":
                case ".jpeg":
                case ".jpg":
                    icon = vxInternalAssets.LoadInternalTexture2D("Textures/gui/icons/picture");
                    break;

                case ".obj":
                case ".fbx":
                case ".stl":
                    icon = vxInternalAssets.LoadInternalTexture2D("Textures/gui/icons/model");
                    break;

                default:
                    icon = vxInternalAssets.LoadInternalTexture2D("Textures/gui/icons/document");
                    break;
            }
