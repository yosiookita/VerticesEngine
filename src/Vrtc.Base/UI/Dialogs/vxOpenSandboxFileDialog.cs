...
namespace VerticesEngine.UI.Dialogs
{
    ...
    public class vxOpenSandboxFileDialog : vxDialogBase
    {
        ...
        public override void LoadContent()
        {
            ...
            Image = new vxImage(Engine, InitialTexture,
                                new Vector2(
            ...
            DeleteFileBtn = new vxButtonControl(Engine, "Delete File",

                new Vector2(ArtProvider.GUIBounds.X + ArtProvider.Padding.X * 2, OKButton.Position.Y));
            ...
            //FileNameLabel.Font = vxGUITheme.Fonts.FontTitle;
        ...
        void AddScrollItem(string file)
        {
            ...
            var fileDialogButton = (OnNewFileDialogItem != null) ? OnNewFileDialogItem(Engine, file) : new vxFileDialogItem(Engine, new FileInfo(file));
        ...
        void DeleteFileBtn_Clicked(object sender, vxGuiItemClickEventArgs e)
        {
