...
namespace VerticesEngine.Screens.Async
{
    ...
    /// </summary>
    public class vxAsyncLoadingScreen : vxGameBaseScreen
    {
        #region Fields
        ...
        /// </summary>
        private vxAsyncLoadingScreen(vxEngine screenManager, bool loadingIsSlow,
                vxGameBaseScreen[] screensToLoad)
        {
                ...
                params vxGameBaseScreen[] screensToLoad)
        {
            ...
            var loadingScreen = new vxAsyncLoadingScreen(screenManager,
                            loadingIsSlow,
                            screensToLoad);
                            ...
                            bool coveredByOtherScreen)
        {
            ...
            if (otherScreensAreGone)
            {
                ...
                vxSceneManager.RemoveScreen(this);

                foreach (vxGameBaseScreen screen in screensToLoad)
                {
                    if (screen != null)
                    {
                        vxSceneManager.AddScreen(screen, ControllingPlayer);
                    }
                }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if ((ScreenState == ScreenState.Active) && (Engine.GetScreens().Length == 1))
            {
            ...
            if (loadingIsSlow)
            {
                ...
                Vector2 textPosition = (viewportSize - textSize) * 0.92f;
