    ...
    public class vxLoadingScreen : vxBaseScene
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (loadingIsSlow)
            {
                ...
                Color color = vxSceneManager.LoadingScreenTextColor * TransitionAlpha;
                ...
                Vector2 messageToDrawPos = new Vector2(Engine.GraphicsDevice.Viewport.Width / 2 - font.MeasureString(messageToDraw).X / 2,
    Engine.GraphicsDevice.Viewport.Height / 2 - font.MeasureString(messageToDraw).Y / 2);
        ...
        void DrawLoadAnimation(GameTime gameTime)
        {
            ...
            try
            {
                graphicsDevice.Clear(vxSceneManager.LoadingScreenBackColor);
