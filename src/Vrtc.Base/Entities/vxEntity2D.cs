        ...
        */
        ...
        public override void Draw (vxCamera camera, string renderpass)
		{
            ...
            if (UsesSpriteSheet)
            {
                ...
                Engine.SpriteBatch.Draw(MainSpriteSheet,
                                        Position,
		...
		public virtual void DrawAnimation()
		{
			if (AnimationSpriteSheet != null)
			{
                ...
                //Engine.SpriteBatch.Draw(AnimationSpriteSheet.Texture, this.Position + AnimationSpriteSheet.Offset,
