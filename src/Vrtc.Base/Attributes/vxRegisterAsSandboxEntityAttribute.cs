...
namespace VerticesEngine
{
    ...
    public class vxRegisterAsSandboxEntityAttribute : Attribute
    {
        ...
        public vxRegisterAsSandboxEntityAttribute(string name, object category, object subCategory, string assetPath, EntityType EntityType = EntityType.BaseEntity, EntityAssetType EntityAssetType = EntityAssetType.Model)
        {
            Name = name;
            Category = category;
