...
namespace VerticesEngine
{
    ...
    public class vxDebugSettingAttribute : vxSettingsAttribute
    {
        /// <summary>
        ...
        public vxDebugSettingAttribute(string displayname, string description = "", bool isSavedToINI = true, bool isMenuSetting = true, 
