...
*/
            ...
            var layout = new vxLayout(GraphicsDevice.Viewport);
        ...
        */
        ...
        public void Draw(Vector2 position, int width)
        {
            ...
            vxLayout layout = new vxLayout(GraphicsDevice.Viewport);
            ...
            foreach (MarkerCollection bar in prevLog.Bars)
            {
                ...
                if (bar.MarkCount > 0)
                {
                    for (int j = 0; j < bar.MarkCount; ++j)
                    {
                        ...
                        runningmax = 150;//Math.Max (time, runningmax);
        ...
        public void DrawGraph()
        {
            ...
            {
                int buffer = 4;
                Engine.SpriteBatch.Begin("Debug - Timer Ruler - Graph");
                Engine.SpriteBatch.Draw(vxInternalAssets.Textures.Blank,
                    ...
                    new Color(0, 0, 0, 150));
                Engine.SpriteBatch.DrawString(font, runningmax.ToString(), new Vector2(rcnew.Right + 5, rcnew.Y), Color.White);
                Engine.SpriteBatch.DrawString(font, 0.ToString(), new Vector2(rcnew.Right + 5, rcnew.Bottom - font.MeasureString("D").Y), Color.White);
