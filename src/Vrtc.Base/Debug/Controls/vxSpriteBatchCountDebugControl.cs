...
namespace VerticesEngine.Diagnostics
{
    ...
    public class vxSpriteBatchCountDebugControl : vxDebugUIControlBaseClass
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            // Draw
            SpriteBatch.Begin("Debug.Profiler.SpriteBatch");

            string sbDebug = "Sprite Batch Profiler";
            sbDebug += "\n-----------------------------------";
            sbDebug += "\nBatch Count: " + SpriteBatch.BatchCallCount;

            int i = 0;
            foreach(var spriteBatchCall in SpriteBatch.BatchCallNames)
            {
                i++;
                sbDebug += "\n" + i + ": " + spriteBatchCall;
            }

            SpriteBatch.DrawString(vxInternalAssets.Fonts.DebugFont, sbDebug, Vector2.One, Color.Black);
            SpriteBatch.DrawString(vxInternalAssets.Fonts.DebugFont, sbDebug, Vector2.Zero, Color.White);
