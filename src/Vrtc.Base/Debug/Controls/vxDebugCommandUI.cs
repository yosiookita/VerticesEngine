...
namespace VerticesEngine.Diagnostics
{
	...
	public class vxDebugCommandUI  : vxDebugUIControlBaseClass, IDebugCommandHost// DrawableGameComponent, IDebugCommandHost 
    {
		...
		public vxDebugCommandUI() :  base("Command UI")
        {
            ...
            //Engine.Game.Services.AddService(typeof(IDebugCommandHost), this);
        ...
        public void Echo(DebugCommandMessage messageType, string text)
        {
            ...
            switch(messageType)
            {
                ...
                case DebugCommandMessage.IO:
                    ...
                    text = messageType + ": " + text;
                    break;
                case DebugCommandMessage.Internal:
        ...
        public override void Update(GameTime gameTime)
        {
			if (vxEngine.BuildType == vxBuildType.Debug)
			{
				...
				//Reset Line Count
				//MaxLineDisplayCount = this.Engine.GraphicsDevice.Viewport.Height / (int)debugManager.DebugFont.MeasureString("A").Y - 3;
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            //Show Title Bar
			spriteBatch.DrawString(font, "     VERTICES ENGINE DEBUG CONSOLE - v." + Engine.EngineVersion, pos,consoleColour);
            ...
            */
			...
			int py = 5;
			rect = new Rectangle (
				GraphicsDevice.Viewport.Width - 2 * px,
				py + barPos,
				3,
				barHeight - 2 * py);
