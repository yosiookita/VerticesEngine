...
namespace VerticesEngine.Diagnostics
{
	...
	public partial class vxDebug
    {
        ...
        /// </summary>
        [vxDebugSettingAttribute("Debug.IsDebugMeshVisible", "", true, true)]
        public static bool IsDebugMeshVisible { get; set; }

        /// <summary>
        /// Is the Debug Render Targets Visible
        /// </summary>
        [vxDebugSettingAttribute("Debug.IsDebugRenderTargetsVisible", "", true, true)]
		...
		public static void AddTool(vxDebugUIControlBaseClass tool)
		{
			DebugTools.Add(tool);
        ...
        public static void InitialiseTool()
		{
            ...
            foreach (Type type in Assembly.GetExecutingAssembly().GetTypes())
            {
                ...
                {
                    vxConsole.WriteIODebug(type.Name);
                    
                    AddTool((vxDebugUIControlBaseClass)Activator.CreateInstance(type));
                }
            }
		...
		internal static void UpdateTools(GameTime gameTime)
		{
