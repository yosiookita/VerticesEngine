...
namespace VerticesEngine.Diagnostics
{
    ...
    public static class vxCrashHandler
	{
        ...
        public static void Init(vxEngine engine, Exception exception)
        {
			...
			CrashFont = vxInternalAssets.LoadInternalSpriteFont("Fonts/font_debug");
            ...
            int scrnwidth = Engine.Game.GraphicsDevice.Viewport.Width - 10;
			...
			try
			{
                ...
                string FileName = string.Format("{1}-{0}.txt", DateTime.Now.ToFileTimeUtc().ToString(), Engine.GameName + "-" + Engine.GameVersion+"-"+vxEngine.PlatformOS);
		...
		public static void Draw(GameTime gameTime)
		{
			if (IsInitialised == true) {
				...
				Engine.Game.GraphicsDevice.Clear (new Color(c,c,c,1));
